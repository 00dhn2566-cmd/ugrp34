...
if isempty(find_system(qcSys2, 'SearchDepth', 1, 'Name', 'Disturb Pulse Z'))
    add_block('simulink/Sources/Pulse Generator', plsB, ...
        'Amplitude', '0.05', 'Period', '100', 'PulseWidth', '0.5', 'PhaseDelay', '8');
end
...
% --- [4] 후보 3세트 실행 ---
gainSets = [6 0 2; 6 0.3 2; 10 0 3; 15 0 4];   % 후보2: 사용자 제안 - 6/0/2에 I 소량 추가
...
for gi = 1:size(gainSets, 1)
    ...
    for ct = [0 2 4 6 8 8.5 9 10 11 12 14 16 20]
        [~, idx] = min(abs(t - ct));
