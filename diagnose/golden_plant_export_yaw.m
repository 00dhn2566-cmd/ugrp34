...
yawk = (pi/4) * (10*tau.^3 - 15*tau.^4 + 6*tau.^5);
sm = traj_smoother(tt, [zeros(N,1), zeros(N,1), ones(N,1)], VMAX, AMAX, JMAX);
waypoints = [0 0 1; 0 0 1.001]';
...
outFile = fullfile(csvDir, 'golden_plant_trace_yaw.csv');
